...
class Chapter3 extends Chapter
{
    ...
    {
        // CODE HERE
         $valueOne = 'Hello my friend %s';
         $valueTwo = str_replace('%s', 'Susan', $valueOne);

         //OR:
         $valueOne = 'Susan';
         $valueTwo = sprintf('Hello my friend %s', $valueOne);
        // DO NOT EDIT BELOW
        return $valueTwo;
    }
    ...
    {
        // CODE HERE
         $valueOne = 'Coding is relaxing after a long day.'
    ...
    {
        // CODE HERE
        $valueOne = 'characteristics';
        $partOne = substr($valueOne, 0, 2);
        $partTwo = substr($valueOne, 4, 8);
    ...
    {
        // CODE HERE
        $valueOne = 'To the mountains';
        $foundLocation = strpos($valueOne, 'm');
        // DO NOT EDIT BELOW
